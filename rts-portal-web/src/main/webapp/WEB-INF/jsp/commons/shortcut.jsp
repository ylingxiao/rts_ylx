	  ...
	  <li class="allCat"><em class="site">网站导航</em><s></s><span class="outline"></span> <span class="blank"></span>
        <div class="dd">
          <dl>
            ...
            <dd>
				<a name="sfbest_hp_hp_head_category1" class="trackref" href="/fresh/" target="_blank">文字砖</a>
				<a name="sfbest_hp_hp_head_category2" class="trackref" href="/fresh/" target="_blank">画像砖</a>
				<a name="sfbest_hp_hp_head_category3" class="trackref" href="/fresh/" target="_blank">碑帖</a>
				<a name="sfbest_hp_hp_head_category4" class="trackref" href="/drinks/4-0-0-0-0-2-0-0-0-0-0.html" target="_blank">摩崖</a>
				<a name="sfbest_hp_hp_head_category5" class="trackref" href="/food/6-0-0-0-0-2-0-0-0-0-0.html" target="_blank">经文</a>
<!-- 				<a name="sfbest_hp_hp_head_category6" class="trackref" href="/tea/5-0-0-0-0-2-0-0-0-0-0.html" target="_blank">冲调茶</a>
          ...
          <dl>
            ...
            <dd><a name="sfbest_hp_hp_head_channel12" class="trackref" href="http://www.sfbest.hk" target="_blank">跨境直发</a>
            ...
            <a name="sfbest_hp_hp_head_channel4" class="trackref" href="/taste/" target="_blank">画廊订购</a>
      ...
      <li class="d3 tShow"><a name="sfbest_hp_hp_head_weibo" class="trackref" title="关注拓片交易网微博" href="http://weibo.com/sfbest" rel="nofollow" target="_blank"><q></q></a></li>
      <li class="d4 tShow"><q></q><!--微信-->
         <div class="dd">
         <div class="sf_wx_t">关注拓片交易网微信</div>
         <div class="sf_wx"></div>
        </div>
        <div class="corner">
          <div class="aBg"></div>
