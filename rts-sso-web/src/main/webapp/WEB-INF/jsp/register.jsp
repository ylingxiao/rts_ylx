...
<body>
		<!-- header -->
		<div class="header">
			<a href="http://localhost:8082"><!-- <img src="/images/logo.pngg" border="0" /> --><span>欢迎注册</span></a>
		</div>
    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.e3mall.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《拓片商城用户注册协议》</font></a>
			</span>
