...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://localhost:8082"><!-- <img src="/images/logo.png" border="0"> --><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	...
	<div class="footer">
		...
		<p>
			北京电子商务有限公司<br> 北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 拓片商城
			ylx.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
